export function RenderContent(){
  ...
  const homeSection = document.querySelector('#home-section').innerHTML = homeHTML;
   ...
   const aboutDetails = {
    myPhoto: 'profile.jpg',
    aboutMeFirstPrgrph: `Hi! I'm Ryokou, a student and programmer who loves sharing creative and inspiring work. I create content featuring my cute programming outputs, turning complex code into visually appealing and fun projects that resonate with my audience.`,
